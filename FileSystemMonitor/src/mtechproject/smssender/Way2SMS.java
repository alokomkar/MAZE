...
public class Way2SMS {
    ...
    {  
        final String USERNAME="9964534673";//REQUIRED
        final String PASSWORD="asilutr";//REQUIRED
        final String ACTION="sa65sdf656fdfd";//REQUIRED : In order to understand ACTION value please read the blog
        //final String ACTION="1358676120889";//REQUIRED : In order to understand ACTION value please read the blog
        
        /*==Way2SMS sms=new Way2SMS();*/
        //HTTP PROXY
        //sms.setProxy("10.1.1.1",8080); //REQUIRED ONLY IF CONNECTING THROUGH A PROXY
        String mobileno = UserAccountDB.MobileLookup(username);
        StringBuilder phoneNumber= new StringBuilder(mobileno);
        ...
        */
        ...
        //for(int i=0;arrPhoneNUmber[i]!= ";";i++)
        //{
         
         //sms.sendSMS(arrPhoneNUmber[0], textMessage, ACTION);
         sms.sendSMS(strPhoneNumber, textMessage, ACTION);
        //}
